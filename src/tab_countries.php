...
$find_sql = "SELECT country_id, country_name, country_min, country_max FROM `countries`";
	...
	<div class="col-xs-12">
		...
		<div class="box">
			...
			<div class="box-body table-responsive">
				<a class="btn btn-primary" href="tab_countries_details.php">
					Create new country
				</a><br /><br />
				<table id="countries_list" class="table table-bordered table-striped">
					<thead>
						<tr>
							<?php
					...
					<tbody>
						...
						foreach($rows as $row)
						{
							...
							<tr>
								...
								<td>
									<a href="tab_countries_details.php?id=<?php echo $row['country_id'] ?>" class="btn btn-primary btn-xs">
										Edit
									</a>
									<a href="tab_countries_delete.php?id=<?php echo $row['country_id'] ?>" onclick="return confirm('Delete row, are you sure?')" class="btn btn-danger btn-xs">
										Delete
									</a>
								</td>
							</tr>
