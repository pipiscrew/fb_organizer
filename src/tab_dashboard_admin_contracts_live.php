...
if (value && value!="null")
		...
		function companyFormatter(value, row) {
			var s ="";
			var fb_page = row.offer_page_url;
			var hyperlinks ="";
			...
			hyperlinks = "&nbsp;&nbsp;<a style='float:right' href='" + s + "' target='_blank'>View Details</a>";
			
			if (fb_page)
				hyperlinks += "<a style='float:right;margin-right:10px' href='http://facebook.com/" + fb_page + "' target='_blank'>FBook</a>";

			return contact_status + value + hyperlinks;
		}
			...
			<button onclick="refresh_grid()" class="btn btn-primary" style="margin-top:25px">Refresh</button>
				...
				<div class="row">					
					<table id="pay_pend_tbl"
						data-url="tab_dashboard_admin_contracts_live_pagination.php"
						...
						<thead>
							<tr>
								...
								<th data-field="offer_page_url" data-visible="false">offer_page_url</th>
