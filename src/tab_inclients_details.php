...
///////////////////READ SPEFIC RECORD
 ...
 if ($row!=null && $row[0]["is_lead"] != 2 )
 	die("Company is not inactive client");
...
//	//init datepicker
//	$('[name=service_starts]').datepicker().on('changeDate', function(ev)
//	{
//		$('[name=service_starts]').datepicker('hide'); //close when selected
//	});
//
//	var d1 = new Date();
...
//		
//	//set default value
//	$('[name=service_starts]').datepicker('setValue', d1)

//	//init datepicker
//	$('[name=service_ends]').datepicker().on('changeDate', function(ev)
//	{
//		$('[name=service_ends]').datepicker('hide'); //close when selected
//	});
//
//	var d1 = new Date();
//	d1.setDate(d1.getDate());
//		
//	//set default value
//	$('[name=service_ends]').datepicker('setValue', d1)
...
//    });
	...
	//set default value
//	$('[name=meeting_datetime]').val(new Date().toISOString().slice(0, 10) + " 00:00");

//    $('[name=next_renewal]').datetimepicker({
//        weekStart: 1,
//        todayBtn:  1,
//		autoclose: 1,
//		todayHighlight: 1,
...
//    });
	...
	//set default value
	//$('[name=next_renewal]').val(new Date().toISOString().slice(0, 10) + " 00:00");

//    $('[name=marketingplan_datetime]').datetimepicker({
//        weekStart: 1,
//        todayBtn:  1,
//		autoclose: 1,
//		todayHighlight: 1,
...
//    });
	...
	//set default value
	//$('[name=marketingplan_datetime]').val(new Date().toISOString().slice(0, 10) + " 00:00");
...
//		$('[name=meeting_location]').val(jArray[0]["meeting_location"]);
//		$('[name=meeting_google]').val(jArray[0]["meeting_google"]);
...
<section class="content-header">
	...
	<?php 
		if (isset($_GET["id"]))
		{
				echo "Update Inactive Client (".$row[0]["client_code"]." - ".$row[0]["client_name"].")";
				echo "<script>document.title = 'pipiscrew - ".$row[0]['client_name']."';</script>";
		}
		else 
			die("you cant create inactive client!");
	?>
	...
	<div class="col-xs-12">
		...
		<div id="tabsContent" class="tab-content">
			...
			<div class="tab-pane fade in active" id="details">
				<?php
				include ('tab_inclients_details_detail.php');
				?>
			</div>
