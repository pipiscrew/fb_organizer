...
$find_sql = "SELECT client_rating_id, client_rating_name FROM `client_ratings` order by client_rating_name";
...
if (isset($_GET["isnew"]))
               echo "client rating inserted!";
elseif (isset($_GET["isupdate"]))
               echo "client rating edited!";
elseif (isset($_GET["isdelete"]))
               echo "client rating deleted!";
	...
	<div class="col-xs-12">
		...
		<div class="box">
			...
			<div class="box-body table-responsive">
				<a class="btn btn-primary" href="tab_client_ratings_details.php">
					Create new client rating
				</a><br /><br />
				<table id="client_ratings_list" class="table table-bordered table-striped">
					<thead>
						<tr>
							<?php
					...
					<tbody>
						...
						foreach($rows as $row)
						{
							...
							<tr>
								...
								<td>
									<a href="tab_client_ratings_details.php?id=<?php echo $row['client_rating_id'] ?>" class="btn btn-primary btn-xs">
										Edit
									</a>
									<a href="tab_client_ratings_delete.php?id=<?php echo $row['client_rating_id'] ?>" onclick="return confirm('Delete row, are you sure?')" class="btn btn-danger btn-xs">
										Delete
									</a>
								</td>
							</tr>
